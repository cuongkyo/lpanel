...
<img src="data/vtr/img/xem.jpg" alt=""/>  <a href="tools.php?act=f&f='.$f.'&ft=code&white=1&d='.$d.'"> '.$chuyenngu['xemnd'].'</a><br/>
<img src="data/vtr/img/xem.jpg" alt=""/>  <a href="edit.php?go=validator&c='.$d.$f.'"> '.$chuyenngu['ktloi'].' XML</a><br/>
<img src="data/vtr/img/xem.jpg" alt=""/>  <a href="edit.php?go=syntax&c='.$d.$f.'"> '.$chuyenngu['ktloi'].' PHP</a><br/>
<img src="data/vtr/img/down.png" alt=""/>  <a href="tools.php?act=f&f='.$f.'&ft=info&d'.$d.'"> '.$chuyenngu['xemma'].' HEX</a><br/>
