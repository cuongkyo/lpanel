...
<img src="data/vtr/img/pma.png" alt=""/>  <a href="tools.php?act=sql"><font color=red>'.$chuyenngu['sqlql1'].'</font></a><br/> 
<img src="data/vtr/img/pma.png" alt=""/>  <a href="saoluu/index.php"><font color=red>'.$chuyenngu['sqlql2'].'</font></a><br/> 
...
<img src="data/vtr/img/key.png" alt=""/>  <a href="tools.php?act=encode">'.$chuyenngu['mahoa'].'</a><br/> 
<img src="data/vtr/img/pass.png" alt=""/>  <a href="tools.php?act=md5">'.$chuyenngu['mahoamd5'].'</a><br/> 
'.tieude($chuyenngu['tonghop']).'
<img src="data/vtr/icon/php.png" alt=""/> <a href="tools.php?act=eval">'.$chuyenngu['chayphp'].'</a> | <a href="change.php?go=eval&c=./">2</a><br/> 
...
<img src="data/vtr/icon/exe.png" alt=""/>  <a href="change.php?go=cmd&c=./">'.$chuyenngu['chay'].' CMD</a> <br/> 
