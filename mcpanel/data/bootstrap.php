...
echo $head;
	...
	//echo $tght;
		...
		if(!empty($cookban)){ 
			...
			echo '<div class="list1">';
			echo '<b>Lấy mật khẩu bằng Email</b><br/> 
	...
	+ Phiên bản: '.$vers.'<br/>
	+ Ngày: 1/1/2015<br/>
	+ Truy cập vào chủ đề trên daivietpda.vn để biết thêm thông tin !	<div class="title">Trở về</div>
...
')){
	...
	<input type="checkbox" value="1" name="doipass"/> <input type="text" name="npass" value=""/>
		...
		echo '<input type="radio" name="edit" '.($setedit=='s' ? 'checked="checked"':'').' value="s"/> '.$chuyenngu['congcu'].' c99.php (S).<br/>';
